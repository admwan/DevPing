...
public class ApplicationContextTest {
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DevPingApplication.class);
	...
	void contextLoads(ApplicationContext context) {
		...
		log.debug("**************** AutowiredCapableBeanFactory: " + contextcontents.toString());
	...
	private boolean testingEnabled() {
    	log.debug("################### In method ***ApplicationContext***Test.testingEnabled() with this.testingEnabled = " + this.testingEnabled);
